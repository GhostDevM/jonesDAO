...
export class StaffRotaComponent implements OnInit {
  ...
  MAX_START_TIME_WEEK: any = {"Monday": "00", "Tuesday": "00", "Wednesday": "00", "Thursday": "00", "Friday": "00", "Saturday": "00", "Sunday": "00"};
  MAX_START_MINUTE_WEEK: any = {"Monday": "00", "Tuesday": "00", "Wednesday": "00", "Thursday": "00", "Friday": "00", "Saturday": "00", "Sunday": "00"};
  
  WORKING_START_TIME:any = '';
  WORKING_END_TIME:any = '';
  WORKING_START_MINUTE:any = '';
  WORKING_END_MINUTE:any = '';
  BREAK_START_TIME:any = '12';
  BREAK_END_TIME:any = '14';
  ...
  MAX_END_TIME_WEEK: any = {"Monday": "00", "Tuesday": "00", "Wednesday": "00", "Thursday": "00", "Friday": "00", "Saturday": "00", "Sunday": "00"};
  MAX_END_MINUTE_WEEK: any = {"Monday": "00", "Tuesday": "00", "Wednesday": "00", "Thursday": "00", "Friday": "00", "Saturday": "00", "Sunday": "00"};
  ...
  BUTTONS_LIST: any = [
      { id:1 ,name: 'Working Day' , value:'' , status: true , colour: '#361b5e' , disabled_colour: '#361b5e'},
      { id:2 ,name: 'Training Day' , value:'Training Day' , status: false ,colour: '#E96D2F' , disabled_colour: '#e1c8bd'},
      { id:3 ,name: 'Sick Day' , value:'Sick Day' , status: false ,colour: '#E96D2F' , disabled_colour: '#e1c8bd'},
      { id:4 ,name: 'Annual Leave' , value:'Annual Leave' , status: false , colour: '#E96D2F' , disabled_colour: '#e1c8bd'},
    ];
  ...
  async lastweek() {
    let count = this.WEEKLY_END.getDate() - this.WEEKLY_START.getDate() + 1;
    this.WEEKLY_START.setDate(this.WEEKLY_START.getDate()-count);

    this.WEEKLY_END.setDate(this.WEEKLY_END.getDate()-count);
    this.resetDate();
  }
  async nextweek() {
    let count = this.WEEKLY_END.getDate() - this.WEEKLY_START.getDate() + 1;
  ...
  async resetDate() {
    ...
    // this.DATEPICKERMODEL = [this.WEEKLY_START, this.WEEKLY_END];

    let WEEKLY_START_STRING = this._getDateString(this.WEEKLY_START);
    let WEEKLY_END_STRING = this._getDateString(this.WEEKLY_END);
    this.DATEPICKERMODEL = [WEEKLY_START_STRING, WEEKLY_END_STRING];
    console.log("this is weekly string",WEEKLY_START_STRING)
    console.log("this is weekly string",WEEKLY_END_STRING)
    // this.DATEPICKERMODEL.push(this.WEEKLY_START);
    // console.log("this.DATEPICKERMODEL",this.DATEPICKERMODEL);
    // this.DATEPICKERMODEL.push(this.WEEKLY_END);
    // this.DATEPICKERMODEL.push(this.WEEKLY_END);
    // this.DATEPICKERMODEL.push( this.WEEKLY_END);
 
    console.log("this.DATEPICKERMODEL",this.DATEPICKERMODEL);
    
    let all_dates = await this._getDatesArrayFromToDateType(this.WEEKLY_START , this.WEEKLY_END);
  ...
  async _selectDateRangePicker (date_value: any) {
    ...
    console.log("this is all dates", all_dates);
    this.WEEK_DAYS_LIST = [];
    this.LIST = [];
    ...
    for (let value of all_dates ) {
      ...
      this.WEEK_DAYS_LIST.push( { date_value: new Date(day).getDate() + ' ' +  this.DAYS_LIST[day_number]  , date: day , dull_date : full_date , date_string : date_string})
      console.log("this is week days list",this.WEEK_DAYS_LIST)
      this.WEEKLY_START = new Date (this.WEEK_DAYS_LIST[0].date);
      this.WEEKLY_END = new Date (this.WEEK_DAYS_LIST[this.WEEK_DAYS_LIST.length - 1].date);
  ...
  _openModel(staff_id: any , value: any , day: any , work_detail_list: any) {
    ...
    let [num_day, week_day] = day.split(' ');
    console.log("this is num_day",num_day)
    console.log("this is week_day",week_day)
    switch (week_day) {
      case 'Sun':
        this.WORKING_START_TIME = this.MAX_START_TIME_WEEK["Sunday"];
        this.WORKING_END_TIME = this.MAX_END_TIME_WEEK["Sunday"];
        this.WORKING_START_MINUTE = this.MAX_START_MINUTE_WEEK["Sunday"];
        this.WORKING_END_MINUTE = this.MAX_END_MINUTE_WEEK["Sunday"];
        break;
      case 'Mon':
        this.WORKING_START_TIME = this.MAX_START_TIME_WEEK["Monday"];
        this.WORKING_END_TIME = this.MAX_END_TIME_WEEK["Monday"];
        this.WORKING_START_MINUTE = this.MAX_START_MINUTE_WEEK["Monday"];
        this.WORKING_END_MINUTE = this.MAX_END_MINUTE_WEEK["Monday"];
        break;
      case 'Tue':
        this.WORKING_START_TIME = this.MAX_START_TIME_WEEK["Tuesday"];
        this.WORKING_END_TIME = this.MAX_END_TIME_WEEK["Tuesday"];
        this.WORKING_START_MINUTE = this.MAX_START_MINUTE_WEEK["Tuesday"];
        this.WORKING_END_MINUTE = this.MAX_END_MINUTE_WEEK["Tuesday"];
        break;
      case 'Wed':
        console.log("here is Wed");
        this.WORKING_START_TIME = this.MAX_START_TIME_WEEK["Wednesday"];
        this.WORKING_END_TIME = this.MAX_END_TIME_WEEK["Wednesday"];
        this.WORKING_START_MINUTE = this.MAX_START_MINUTE_WEEK["Wednesday"];
        this.WORKING_END_MINUTE = this.MAX_END_MINUTE_WEEK["Wednesday"];
        break;
      case 'Thu':
        this.WORKING_START_TIME = this.MAX_START_TIME_WEEK["Thursday"];
        this.WORKING_END_TIME = this.MAX_END_TIME_WEEK["Thursday"];
        this.WORKING_START_MINUTE = this.MAX_START_MINUTE_WEEK["Thursday"];
        this.WORKING_END_MINUTE = this.MAX_END_MINUTE_WEEK["Thursday"];
        break;
      case 'Fri':
        this.WORKING_START_TIME = this.MAX_START_TIME_WEEK["Friday"];
        this.WORKING_END_TIME = this.MAX_END_TIME_WEEK["Friday"];
        this.WORKING_START_MINUTE = this.MAX_START_MINUTE_WEEK["Friday"];
        this.WORKING_END_MINUTE = this.MAX_END_MINUTE_WEEK["Friday"];
        break;
      case 'Sat':
        this.WORKING_START_TIME = this.MAX_START_TIME_WEEK["Saturday"];
        this.WORKING_END_TIME = this.MAX_END_TIME_WEEK["Saturday"];
        this.WORKING_START_MINUTE = this.MAX_START_MINUTE_WEEK["Saturday"];
        this.WORKING_END_MINUTE = this.MAX_END_MINUTE_WEEK["Saturday"];
        break;
    }
    console.log("starttime", this.WORKING_START_TIME);
    console.log("endtime", this.WORKING_END_TIME);
  ...
  async _changeFullDayOff () {
   ...
   async _getBusinessHours () {
    await ((await this.staffService.getBusinessHours()).subscribe)(
      async (response: any) => {
        console.log("this is resoponse",response)
        let value:any ;
        for(value of response) {
          let working_status = value.open_status;
          let working_day = value.day;
          console.log("this is workng day", working_day);
          if (working_status) {
            let [starthour, startminute] = value.start_time.split(':');
            let [endhour, endminute] = value.end_time.split(':');
            this.MAX_START_TIME_WEEK[working_day] = starthour;
            this.MAX_END_TIME_WEEK[working_day] = endhour;
            this.MAX_START_MINUTE_WEEK[working_day] = startminute;
            this.MAX_END_MINUTE_WEEK[working_day] = endminute;
            
          }
          // console.log("wednesday", this.MAX_START_TIME_WEEK["Wednesday"]);
          
          
        }
        // this.WORKING_START_TIME = this.MAX_START_TIME_WEEK[1];
        // this.WORKING_END_TIME = this.MAX_END_TIME_WEEK[1];
        // console.log("maxStartTIMEWEEK", this.MAX_START_TIME_WEEK);
        // console.log("maxStartTIMEWEEK", this.MAX_END_TIME_WEEK);
      },
      (error: any) => {
        this.spinner.hide();
      }
  ...
  _getDatesArrayFromTo (start , end) {
   ...
   _getDatesArrayFromToDateType (start:any , end: any) {
