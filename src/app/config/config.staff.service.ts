...
export class ConfigStaffService {
  ...
  async getBusinessHours () {
    return this.http.get(this.configUrl + '/settings/getBusinessHours');
  }
  async _getStaffRota() {
  ...
  async _createCashCharge (data) {
    ...
    const headers = {   };
    // const body = JSON.stringify(data);
    console.log("this is create cash",data)

    return this.http.post(this.configUrl + '/stripe/create-cash-charge', data , {'headers': headers })
  }
